...
cash_flow_df.replace(" ", np.nan, inplace = True)
cash_flow_df.replace('%,+', '',inplace=True)
#cash_flow_df.isnull().sum()
#df = cash_flow_df.columns.str.replace('[#,@ ,&,+ ,,%,n ]', '').str.strip()
cash_flow_df.columns = cash_flow_df.columns.str.replace('[#,@ ,&,+ ,%,\n ]', ' ')
cash_flow_df.replace('', 0,inplace=True)
cash_flow_df.columns = cash_flow_df.columns.str.lstrip() # Leading only
cash_flow_df.columns = cash_flow_df.columns.str.rstrip() # Trailing only
cash_flow_df.set_index('Type', inplace=True)
cash_flow_df.index.name = None
df = cash_flow_df.T.reset_index()
